    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between gap-4">
        <div>
          ...
          <p className="mt-2 text-[#9aa8bc]">{imageFile?.name}</p>
        </div>
      ...
      <div className="flex min-h-[420px] items-center justify-center overflow-hidden rounded-3xl border border-[#40506a] bg-black/30">
        <img
          src={previewUrl}
      ...
      <div className="flex flex-wrap justify-between gap-4">
        <div className="flex gap-3">
          <button
            ...
            disabled={isProcessing}
            className="inline-flex items-center gap-2 rounded-2xl bg-[#78b7ee]/12 px-5 py-3 font-semibold text-white transition hover:bg-[#78b7ee]/20 disabled:cursor-not-allowed disabled:opacity-60"
          >
        ...
        <div className="flex flex-wrap gap-3">
          ...
          <button
            ...
            disabled={isProcessing}
            className="rounded-2xl bg-[#78b7ee] px-6 py-3 font-semibold text-white transition hover:bg-[#8cc5f4] disabled:cursor-not-allowed disabled:opacity-60"
          >
